...
define('ddah-ember/tests/helpers/politicalWillPerArea.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | helpers/politicalWillPerArea.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'helpers/politicalWillPerArea.js should pass jshint.');
  });
});
...
define('ddah-ember/tests/unit/models/area-test', ['exports', 'ember-qunit', 'ember'], function (exports, _emberQunit, _ember) {
  ...
  (0, _emberQunit.moduleForModel)('area', 'Unit | Model | area', {
    ...
    loadData: function loadData() {
      ...
      var justification1 = this.store().createRecord('justification', { 'promise': promesa_1, 'bill': bill_a });
  ...
  (0, _emberQunit.test)('area getPoliticalWillByStudy', function (assert) {
    var data = this.loadData();
    _ember['default'].run.begin();
