...
define('ddah-ember/helpers/politicalWillPerArea', ['exports', 'ember'], function (exports, _ember) {
  exports.politicalWillPerArea = politicalWillPerArea;

  function politicalWillPerArea(params /*, hash*/) {
    var area = params[0];
    var study = params[1];
    return area.getPoliticalWillByStudy(study);
  }

  exports['default'] = _ember['default'].Helper.helper(politicalWillPerArea);
});
...
define('ddah-ember/models/area', ['exports', 'ember-data', 'ddah-ember/mixins/calculations'], function (exports, _emberData, _ddahEmberMixinsCalculations) {
  exports['default'] = _emberData['default'].Model.extend(_ddahEmberMixinsCalculations['default'], {
    ...
    getPoliticalWillByStudy: function getPoliticalWillByStudy(study) {
      var promises = this.getPromisesPerStudy(study);
      var count = 0;
...
if (!runningTests) {
  require("ddah-ember/app")["default"].create({"name":"ddah-ember","version":"0.0.0+c371e9bd"});
}
